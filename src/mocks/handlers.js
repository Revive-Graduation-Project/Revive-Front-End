...
export const MOCK_HANDLERS = [
    ...
    },
    {
        ...
        handler: () => ({ status: 200, data: mockMeals }),
    },
    {
        method: 'post',
        match: (url) => url.endsWith('/menu'),
    ...
    },
    {
        ...
        handler: () => ({ status: 200, data: { message: 'Reward redeemed', pointsRemaining: 320 } }),
    },
];
...
export const resolveMockHandler = (config) => {
    ...
    if (!handler) {
        ...
        return { status: 404, data: { message: `Mock not implemented: ${method?.toUpperCase()} ${url}` } };
    }
