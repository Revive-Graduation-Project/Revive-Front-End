    ...
    >
      <div className="bg-white rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-slide-in">
        <div className="p-6 flex flex-col items-center text-center gap-4">
          ...
          <h2 id="confirm-modal-title" className="text-[20px] font-bold text-gray-900 leading-tight">
            {title || "Are you sure?"}
          </h2>
          <p id="confirm-modal-message" className="text-[14px] font-medium text-gray-500 leading-relaxed">
