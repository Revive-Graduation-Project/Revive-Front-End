  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-8">
      ...
      >
        ...
        <span className="font-medium text-gray-800 flex-1">Cash on delivery</span>
        {paymentMethod === "cash" && (
      ...
      <div 
        ...
        className={`flex flex-col gap-2 p-4 cursor-pointer hover:bg-gray-50 transition-colors ${
      ...
      >
        ...
        {/* Render Stripe Card Element inline if selected */}
        {paymentMethod === "credit_card" && (
            <div className="mt-2 ml-14 p-3 bg-white border border-gray-300 rounded-md shadow-sm" onClick={e => e.stopPropagation()}>
               <CardElement options={{
                   style: {
                       base: {
                           fontSize: '16px',
